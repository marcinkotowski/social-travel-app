...
export const register = (req, res) => {
  ...
  db.query(q, [req.body.username], (err, data) => {
    ...
    const values = [req.body.username, name, req.body.email, hashedPassword];
  ...
  db.query(q, [req.body.username], (err, data) => {
    ...
    res
      .cookie("accessToken", token, {
        httpOnly: true,
        /* Random script cannot use our cokkie */
      })
      .status(200)
      .json(others);
  });
...
export const logout = (req, res) => {
  res
    .clearCookie("accessToken", {
      secure: true,
      sameSite: "none",
      /* server and client server (8800/3000)  is not the same*/
    })
    .status(200)
